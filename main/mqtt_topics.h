...
enum class mqtt_topic_id_t : uint16_t {
    ...
    TOPIC_STAV_CERPANI_PUMPA_BEZI,
    TOPIC_STAV_CERPANI_PUMPA_VYKON_CINNY_W,
    TOPIC_STAV_CERPANI_PUMPA_JALOVY_VYKON_VAR,
    TOPIC_STAV_CERPANI_PUMPA_COSFI,
    TOPIC_STAV_CERPANI_PUMPA_PROUD_A,
    TOPIC_STAV_CERPANI_PUMPA_NAPETI_V,
    TOPIC_STAV_CERPANI_PUMPA_ENERGIE_CINNA_KWH,
    TOPIC_STAV_CERPANI_PUMPA_ENERGIE_JALOVA_KVARH,
