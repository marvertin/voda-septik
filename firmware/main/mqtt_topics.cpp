...
const mqtt_topic_descriptor_t MQTT_TOPIC_TABLE[(size_t)mqtt_topic_id_t::COUNT] = {
    ...
    TOPIC_ENTRY(TOPIC_STAV_CERPANI_PUMPA_STAV,           "stav/cerpani/pumpa/stav",          PUBLISH_ONLY,   TEXT,    1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_NAPETI_V,         "elektro/cerpadlo/napeti_v",        PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_PROUD_A,          "elektro/cerpadlo/proud_a",         PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_VYKON_CINNY_W,    "elektro/cerpadlo/vykon_cinny_w",   PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_VYKON_JALOVY_VAR, "elektro/cerpadlo/vykon_jalovy_var", PUBLISH_ONLY,  NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_VYKON_ZDANLIVY_VA, "elektro/cerpadlo/vykon_zdanlivy_va", PUBLISH_ONLY, NUMBER, 1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_FREKVENCE_HZ,     "elektro/cerpadlo/frekvence_hz",    PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_COSFI,            "elektro/cerpadlo/cosfi",           PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_ENERGIE_CINNA_KWH, "elektro/cerpadlo/energie_cinna_kwh", PUBLISH_ONLY, NUMBER, 1, true),
    TOPIC_ENTRY(TOPIC_ELEKTRO_CERPADLO_ENERGIE_JALOVA_KVARH, "elektro/cerpadlo/energie_jalova_kvarh", PUBLISH_ONLY, NUMBER, 1, true),
    ...
    TOPIC_ENTRY(TOPIC_DIAG_WIFI_CONNECTS,                "diag/wifi/connects",               PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_WIFI_DISCONNECTS,             "diag/wifi/disconnects",            PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MQTT_CONNECTS,                "diag/mqtt/connects",               PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MQTT_DISCONNECTS,             "diag/mqtt/disconnects",            PUBLISH_ONLY,   NUMBER,  1, true),
    ...
    TOPIC_ENTRY(TOPIC_DIAG_ADS1115_STATUS,               "diag/ads1115/status",              PUBLISH_ONLY,   TEXT,    1, true),
    TOPIC_ENTRY(TOPIC_DIAG_ADS1115_READ_ERRORS,          "diag/ads1115/read_errors",         PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_ADS1115_LAST_OK_AGE_S,        "diag/ads1115/last_ok_age_s",       PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MODBUS_KWS_STATUS,            "diag/modbus/kws/status",           PUBLISH_ONLY,   TEXT,    1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MODBUS_KWS_TIMEOUTS,          "diag/modbus/kws/timeouts",         PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MODBUS_KWS_CRC_ERRORS,        "diag/modbus/kws/crc_errors",       PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MODBUS_KWS_READ_ERRORS,       "diag/modbus/kws/read_errors",      PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MODBUS_KWS_LAST_OK_AGE_S,     "diag/modbus/kws/last_ok_age_s",    PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_TEPLOTA_STATUS,               "diag/teplota/status",              PUBLISH_ONLY,   TEXT,    1, true),
    TOPIC_ENTRY(TOPIC_DIAG_TEPLOTA_BUS_ERRORS,           "diag/teplota/bus_errors",          PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_TEPLOTA_CRC_ERRORS,           "diag/teplota/crc_errors",          PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_TEPLOTA_READ_ERRORS,          "diag/teplota/read_errors",         PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_TEPLOTA_LAST_OK_AGE_S,        "diag/teplota/last_ok_age_s",       PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_SENSOR_QUEUE_DROPS,           "diag/events/sensor_queue_drops",   PUBLISH_ONLY,   NUMBER,  1, true),
    TOPIC_ENTRY(TOPIC_DIAG_MQTT_PUBLISH_QUEUE_DROPS,     "diag/mqtt/publish_queue_drops",    PUBLISH_ONLY,   NUMBER,  1, true),
